...
//        mServiceReachability.start();
    ...
    public void launchDisneyPlus(String contentId, AppLaunchListener listener) {
        final String appName = "DisneyPlus";
    ...
    public void launchAmazonPrime(String contentId, AppLaunchListener listener) {
        final String appName = "Amazon Prime";
...
//    }
    ...
    protected void updateCapabilities() {
        ...
        if (DiscoveryManager.getInstance().getPairingLevel() == PairingLevel.ON) {
            ...
            capabilities.add(DisneyPlus);
            capabilities.add(DisneyPlus_Params);
            capabilities.add(AmazonPrime);
            capabilities.add(AmazonPrime_Params);
