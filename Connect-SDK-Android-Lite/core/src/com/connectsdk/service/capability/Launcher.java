...
public interface Launcher extends CapabilityMethods {
    ...
    public final static String DisneyPlus = "Launcher.DisneyPlus";
    public final static String DisneyPlus_Params = "Launcher.DisneyPlus.Params";
    public final static String AmazonPrime = "Launcher.AmazonPrime";
    public final static String AmazonPrime_Params = "Launcher.AmazonPrime.Params";
    ...
    public void launchDisneyPlus(String contentId, AppLaunchListener listener);
    public void launchAmazonPrime(String contentId, AppLaunchListener listener);
